...
const BlogPost = () => {
  ...
  return (
    <div>
      <Hero title="SILVERLINERIMS BLOG" imageLabel="bg-bgBlog1" />
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[400px] sm:items-center sm:justify-center md:items-start md:justify-start ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            ...
            Silverlinerims, we are passionate about crafting high-quality rims
            that not only elevate the aesthetics but also enhance the driving
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[400px] sm:items-center sm:justify-center md:items-start md:justify-start ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            ...
            weight and improves handling and fuel efficiency. Silverlinerims
            offers a diverse array of alloy rims, each with its own distinctive
            design, catering to various vehicle types and personal preferences.
            Whether you crave a sleek and modern look or a sporty and aggressive
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[400px] sm:items-center sm:justify-center md:items-start md:justify-start  ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            ...
            agility, cornering, and braking capabilities. Silverlinerims' forged
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[400px] sm:items-center sm:justify-center md:items-start md:justify-start ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            ...
            go. At Silverlinerims, our chrome plated rims undergo a meticulous
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[400px] sm:items-center sm:justify-center md:items-start md:justify-start  ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            At Silverlinerims, we understand that every car enthusiast has a
            unique vision for their vehicle. Our team of skilled designers and
      ...
      <div className="max-w-7xl mx-auto h-[150px] flex flex-col items-start justify-start gap-y-3 mt-1 lg:p-4 md:p-4 sm:h-[460px] sm:items-center sm:justify-center md:items-start md:justify-start  ">
        ...
        <div className="w-[1133px] h-[63px]  lg:w-[980px] md:w-[720px] sm:w-[320px]  xl:w-full sm:h-[auto] sm:p-3">
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            ...
            of your vehicle. At Silverlinerims, we take pride in offering a wide
          ...
          <br />
          <span className="sm:text-sm md:text-sm lg:text-lg xl:text-2xl text-primary font-poppins">
            Explore our extensive collection of rims and let Silverlinerims be
            your trusted partner in elevating your ride to new heights of style,
            performance, and excellence. Embrace the art of automotive elegance
            - Choose Silverlinerims today!
          </span>
        </div>
      </div>
