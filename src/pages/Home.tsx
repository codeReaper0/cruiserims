...
import carousel1 from "../assets/quality-img3.png";
import carousel2 from "../assets/quality-pro4.png";
import carousel3 from "../assets/quality-pro.png";
      ...
      <div className="w-full h-[452px] relative group">
        ...
        {!isMobile && (
          <div
            ...
            className="w-full h-full bg-center bg-cover duration-500 sm:hidden md:hidden lg:block xl:block relative"
          >
            <div className="absolute inset-0 bg-black/60 backdrop-blur flex flex-col items-center justify-center gap-6 text-white">
              <h1 className="font-jost font-black text-[48px] xl:text-[78px]">
                WELCOME TO SILVERLINE RIMS
              </h1>
              <p className="text-lg xl:text-xl font-semibold">
                YOUR PREMIER RIM MANUFACTURING COMPANY IN THE USA
              </p>
            </div>
          </div>
        )}
        {!isMobile && (
          <div
            style={{backgroundImage: `url(${slides[currentIndex].url})`}}
            className="w-full h-full bg-center bg-cover duration-500 lg:hidden relative"
          >
            <div className="absolute inset-0 bg-black/60 backdrop-blur flex flex-col items-center justify-center gap-6 text-white">
              <h1 className="font-jost font-black text-lg">
                WELCOME TO SILVERLINE RIMS
              </h1>
              <p className="text-xs text-center max-w-[250px] mx-auto font-semibold">
                YOUR PREMIER RIM MANUFACTURING COMPANY IN THE USA
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 h-[200px]">
            ...
            <div className="w-[300px] text-center">
              <span className="text-center text-xs font-poppins">
                At Silverlinerims, we take pride in our exceptional
                craftsmanship, delivering top-quality rims that elevate the
                style and performance of your vehicles. Each rim is meticulously
          ...
          <div className="flex flex-col items-center justify-center space-y-4 w-[300px] h-[200px]">
            ...
            <div className="w-[300px] text-center">
              <span className="text-center text-xs font-poppins">
                ...
                Silverlinerims' products are built to last, providing unmatched
          ...
          <div className="flex flex-col items-center justify-center space-y-4 w-[300px] h-[200px]">
            ...
            <div className="w-[300px] text-center">
              <span className="text-center text-xs font-poppins">
                ...
                industry advancements with Silverlinerims, and experience the
                thrill of driving on the forefront of style and performance.
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 w-[300px] h-[200px]">
            ...
            <div className="w-[300px] text-center">
              <span className="text-center text-xs font-poppins">
                ...
                when it comes to rims. Silverlinerims' products are engineered
                to simplify your life, ensuring that you spend more time on the
          ...
          <div className="flex flex-col items-center justify-center space-y-4 w-[300px] h-[200px]">
            ...
            <div className="w-[300px] text-center">
              <span className="text-center text-xs font-poppins">
                ...
                guarantee on all Silverlinerims products. Drive with confidence,
