...
const Products = () => {
  ...
  return (
    <div>
      {/* Hero && Navbar */}
      <Hero
        title="SILVERLINERIMS PRODUCT PAGE"
...
FEA tested to VIA, SAE and TUV safety standards"
      ...
      <div className="flex flex-col items-center justify-center space-y-3">
        <Qualities
          ...
          subtitle="At Silverlinerims, we take great pride in offering a diverse range of top-quality 
...
fit for your ride.."
        ...
        <Qualities
          ...
          subtitle="Each Silverlinerims product is a testament to our commitment to excellence. 
...
rims provide the best driving experience, be it on city streets or challenging
 terrains."
        ...
        <Qualities
          ...
          subtitle="Silverlinerims is committed to environmentally friendly practices. We employ 
...
collection now and experience the Silverlinerims difference. Unleash the true 
