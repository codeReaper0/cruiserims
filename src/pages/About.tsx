  ...
  return (
    <div>
      ...
      <div className="max-w-7xl bg-black mt-9 mx-auto flex flex-col space-y-9 items-center justify-center lg:w-[1010px] lg:mx-auto lg:p-5 p-8 sm:w-[320px] md:w-[750px] xl:w-full xl:mx-auto">
        ...
        <div className="text-center">
          <span className="text-sm font-poppins text-secondary">
            Welcome to Silverlinerims, a leading rim manufacturing company based
            in the USA. We are passionate about crafting high-quality rims that
            not only elevate the appearance of vehicles but also enhance their
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 md:space-x-2 p-1 md:max-w-7xl md:mx-auto  lg:w-full ml-1 ">
        ...
        <Features
          title="OUR JOURNEY"
          subtitle="Silverlinerims was founded by a team of 
        ...
        <Features
          title="CRAFTSMANSHIP"
          subtitle="At Silverlinerims, we believe that every rim is 
