...
const Career = () => {
  ...
  return (
    <div>
      {/* Hero && Navigation */}
      <Hero
        title="JOIN THE SILVERLINERIMS TEAM"
      ...
      <div className="bg-black max-w-7xl mx-auto rounded-md h-[280px] sm:w-full flex flex-col items-center justify-center gap-y-4 mt-4 ">
        ...
        <div className="w-[1133px] h-[63px] text-center  lg:w-[980px] md:w-[720px] sm:w-[320px] sm:h-[auto] sm:p-3">
          <span className="text-sm text-secondary font-montserrat">
            At Silverlinerims, we believe that our success lies in the
            dedication and talent of our team members. As a fast-growing rim
            manufacturing company based in the USA, we offer an exciting and
            dynamic work environment where innovation and creativity thrive.
            Join us, and together, we'll shape the future of the automotive
            industry.
          </span>
        </div>
      </div>
      ...
      <div className="bg-black max-w-7xl mx-auto rounded-md h-[350px] flex flex-col items-center justify-center gap-y-4 mt-[2rem] mb-4 ">
        ...
        <div className="w-[1133px] h-[63px] text-center  lg:w-[980px] md:w-[720px] sm:w-[320px] sm:h-[auto] sm:p-3">
          <span className="text-xs text-secondary font-poppins">
            ...
            to offer to Silverlinerims, we'd love to hear from you. Send us your
          ...
          <span className="text-xs text-secondary font-poppins">
            ...
            Silverlinerims team, email your resume and a cover letter detailing
            your qualifications and passion for our industry to
            <span className="text-tertiary font-poppins">
              careers@silverlinerims.com.
            </span>
          </span>
        </div>
      </div>
      ...
      <div className="bg-black max-w-7xl mx-auto rounded-md h-[350px] flex flex-col items-center justify-center gap-y-4 mt-[2rem] mb-4 ">
        ...
        <div className="w-[1133px] h-[63px] text-center  lg:w-[980px] md:w-[720px] sm:w-[320px] sm:h-[auto] sm:p-3">
          <span className="text-xs text-secondary font-poppins">
            At Silverlinerims, we offer more than just jobs; we provide a
            platform for individuals to thrive and grow. Join us on this
            exciting journey of innovation, craftsmanship, and automotive
            excellence. Together, let's elevate your career to new heights.
          </span>
        </div>
      </div>
